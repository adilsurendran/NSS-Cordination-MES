...
// import api from "../../services/api"; // You can connect this later to your backend
...
//     try {
//       if (editItem) {
//         // 🔹 Update Event (replace with API call)
//         // setEvents((prev) =>
//         //   prev.map((e) => (e.id === editItem.id ? { ...editItem, ...form } : e))
//         // );
...
//           console.log(reqres);
//           fetchEvents();
//           // alert(reqres.data.message || 'updated succesfully')
          
//         }
//         catch(e){
//           console.log(e);
//           // alert(e.response.data.message || "updation failed")
//         }
...
//         });
//       } else {
//         // 🔹 Add Event (replace with API call)
//         console.log(form);
